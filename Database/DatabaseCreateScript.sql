...
--
-- Table structure for table `RadioElement`
--

CREATE TABLE `RadioElement` (
  `RadioElementID` int(11) NOT NULL,
  `RadioType` varchar(255) DEFAULT NULL,
  `RadioChannel` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- RELATIONS FOR TABLE `RadioElement`:
--
...
--
-- Indexes for table `RadioElement`
--
ALTER TABLE `RadioElement`
  ADD PRIMARY KEY (`RadioElementID`);
